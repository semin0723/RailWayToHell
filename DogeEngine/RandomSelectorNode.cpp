...
bool RandomSelectorNode::SetChildNodeProbability(unsigned int idx, float probability)
{
...
void RandomSelectorNode::AttachChildAt(BaseBTNode* node, unsigned int index)
{
...
void RandomSelectorNode::DetachChildAt(unsigned int index)
{
    delete Childs[index];
